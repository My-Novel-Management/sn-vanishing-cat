...
def a_cat(w: World):
    ...
    return w.scene("猫",
            ...
            yuji.do("ソファの背には斜めに引っかき傷が付いていて、それはおそらくこれからも少しずつ増えていくのだろうが、彼女のことを考えると新しく買い換えるのもどうなのだろうかとなかなか踏ん切りが付かない。やはり慣れたものの方が居心地良く思ってくれるような気がするのだ",
                ...
                "缶同士が乾いた音を響かせたのが気に障ったようだ"),
            yuji.talk("アリィ？"),
            yuji.hear("そう呼びかけると小さな返事がした。実によく似ている。猫の声そのものだ"),
            yuji.do("$meはソファまで戻ると、自分を見上げて小さく歯を見せた彼女の頭を撫でる。目を閉じて気持ちよさそうに低く唸る。最初は喉を鳴らすその声に慣れなかったが、最近ではこれが彼女の安寧の声なのだと理解が進んできた",
                "だがその声は不意に無機質な電子音声に変わる"),
            ally.talk("バッテリィ残量が少なくなりました。充電して下さい"),
            yuji.talk("ああ、分かったよ"),
            yuji.do("$meは仕方なく彼女を足元から抱き上げて持ち上げると、壁際に立つロケット発射台のような金属のアームとプラスチックの置き型充電器まで運ぶ。彼女の四肢を支えながら腹部を台に載せ、背中を押さえるようにアームを下ろすと、目を閉じて動かなくなってしまった。その胴体に『Charging』と赤字が浮かび上がったのを確認し、僕はパソコンデスクに戻る"),
...
def lookfor_her(w: World):
    ...
    return w.scene("彼女を探して",
            w.symbol("◆"),
            yuji.do("慌てて駅の階段を駆け上がるとブロックが敷き詰められた駅前広場にはベビィカーを押す女性やカップルらしき男女が目に付いたが、雉色の猫に限らず動物の姿は鳩以外なかった"),
            yuji.do("右手には数年前から故障したままになっている大観覧車の姿が見えて、あまり良くない思い出が蘇ったが、それを振り切るように頭を揺らすと公園の方に足を向けた",
                "猫だから何かの拍子に家を出ていき迷子になったりして居なくなる。そういう可能性については既にキースと検討を充分に済ませていたから、一つの対策としてＧＰＳで場所を特定できるようにはしておいた",
                "ただそれは猫ロボットが電波を発信できる状態が確保されている必要があり、意図的にそれを遮断されてしまった場合においては、従来の猫と同様、目視で探すしかなくなる",
                "その不完全さを解消する手段は結局、家から彼女を出られないようにするしかないのだろう"),
            ...
            yuji.do("けれどそれは仕方のないことだ。彼女は人ではない。猫ですらない。ただのロボットだ。見た目こそよく自然の猫に似せて造られているが、その声も温度も仕草も、所詮は造りものでしかない",
            ...
            yuji.do("動かなくなったままの大観覧車の下までやってきたが、彼女は見つからない",
                ...
                "閉鎖中と書かれた黄色いプレートのぶら下がる前に腰を下ろし、砂浜の方を見やる。まだ入るには水が冷たいかも知れないと思うが意外と人が集まっていて、賑やかな声が聞こえてくる"),
            yuji.talk("いや、あれは……"),
            ...
            yuji.do("その人垣から抜け出て、大観覧車の前まで戻ってくる",
                "ハンカチでは上手く水分を取り切れないが、内部にまで水が入っていないことは確認できた。注意深く彼女の胴体側面にある起動スイッチを入れる。一瞬目が光るが、彼女は動いたりはしなかった"),
            yuji.talk("アリィ？"),
            yuji.do("名前を呼んでみる"),
            yuji.talk("アリィどうしたんだ？"),
...
def always_vanish(w: World):
    ...
    return w.scene("いつもいなくなる",
            ...
            yuji.do("最初に僕は電波などのハードへの影響を考えたが、キースはすぐソフト面、つまりプログラムか或いは猫を模した人工脳そのものの作用だと指摘した",
                "納得はいかなかったが、それでも無限に代用のボディを用意できる訳ではない。仕方なく彼女の人工神経回路にある種のブレーキプログラムを組み込んだ。それは彼女がいなくなる直前に発する奇妙な回路の動きを捉えたことからキースが提案した案だったが、実際そのブレーキは上手く利いた"),
            yuji.talk("またなのか……"),
...
def friend(w: World):
    ...
    return w.scene("友人",
            ...
            yuji.do("半年ぶりに会ったキースは相変わらず日焼けした真っ黒な肌で、毛深い腕を派手なアニメのプリントされたシャツからはみ出させながらガハハと笑った",
            ...
            yuji.think("その仕草に、この男と会うきっかけを与えてくれた彼女のことを思い出す",
                "外に出て、人と人を会わせるのが自分の仕事だと楽しそうに語ってくれた彼女も、いつの間にか僕の前からいなくなってしまった。ひょっとすると誰もが僕から離れていってしまうのかも知れない。そういうプログラムが組み込まれているのだ。なら、アリィが出ていくのもまた、僕の所為ということになる",
